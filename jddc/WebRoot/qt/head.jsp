...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path%>/qt/res/static/css/main.css">
    <link rel="stylesheet" type="text/css" href="<%=path%>/qt/res/layui/css/layui.css">
    <link rel="stylesheet" href="<%=path%>/qt/res/bootstrap-3.3.7-dist/css/bootstrap.min.css">
                ...
                <div class="headerCon">
                    ...
                    <div class="mallSearch">
                        <form action="" class="layui-form" novalidate="">
                            <input type="text" name="title" required="" lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入需要的菜名">
