...
public class CodeUtil {
	...
	public static String getCodeStr(int len) {
		String prefix = new SimpleDateFormat("yyyyMMddHHmmssSSS")
				.format(new Date());
	...
	/**
	 * 部门：通信与企业互联事业部 功能：生成时间戳字符串 描述：略 作成者：朱庆锋 作成时间：2018年6月10日
	 */
	...
	/**
	 * 部门：通信与企业互联事业部 功能： 描述：略 作成者：朱庆锋 作成时间：2018年6月10日
	 */
	...
	/**
	 * 部门：通信与企业互联事业部 功能：左补零 描述：略 作成者：朱庆锋 作成时间：2018年6月10日
	 */
